...
data_params.root_savedir = '../kdesfeatures/';
data_params.savedir = ['../kdesfeatures/kernel/rgbd' 'normalkdes_dep'];
...
if featag
   ...
   save([data_params.root_savedir 'rgbdfea_pcloud_normalkdes'], 'rgbdfea','-v7.3');
else
   load [data_params.root_savedir 'rgbdfea_pcloud_normalkdes'];
end
