...
data_params.savedir = ['../kdesfeatures/kernel/rgb' 'gradkdes_dep'];
...
if featag
   ...
   save([data_params.root_savedir 'rgbdfea_rgb_gradkdes'], 'rgbdfea', '-v7.3');
else
   load [data_params.root_savedir 'rgbdfea_rgb_gradkdes'];
end
