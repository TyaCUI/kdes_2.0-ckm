...
data_params.savedir = ['../kdesfeatures/kernel/rgb' 'lbpkdes_dep'];
...
if featag
   ...
   save([data_params.root_savedir 'rgbdfea_rgb_lbpkdes'], 'rgbdfea', '-v7.3');
else
   load [data_params.root_savedir 'rgbdfea_rgb_lbpkdes'];
end
