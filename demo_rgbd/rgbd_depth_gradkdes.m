...
data_params.savedir = ['../kdesfeatures/kernel/rgbd' 'gradkdes_dep'];
...
if featag
   ...
   basis_params.wordnum = 1000; % number of visual words 1000
   ...
   save([data_params.root_savedir 'rgbdfea_depth_gradkdes'], 'rgbdfea', '-v7.3');
else
   load([data_params.root_savedir 'rgbdfea_depth_gradkdes']);
end
