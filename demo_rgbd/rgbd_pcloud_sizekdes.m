...
data_params.savedir = ['../kdesfeatures/kernel/rgbd' 'sizekdes_dep'];
...
if featag
   ...
   save([data_params.root_savedir 'rgbdfea_pcloud_sizekdes'], 'rgbdfea', '-v7.3');
else
   load [data_params.root_savedir 'rgbdfea_pcloud_sizekdes'];
end
