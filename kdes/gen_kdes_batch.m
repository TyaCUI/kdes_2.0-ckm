...
parfor i = 1:length(data_params.datapath)
    ...
    switch kdes_params.kdes.type
         ...
         case {'gradkdes_dep', 'lbpkdes_dep'}
              % read a depth map
              I = swapbytes(imread(data_params.datapath{i}));
    ...
    save_kdes_batch([data_params.savedir '/' sprintf('%06d',i)], feaSet);
...
function save_kdes_batch(savepath, feaSet)
save(savepath, 'feaSet');
